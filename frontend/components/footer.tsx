      ...
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
              ...
              <div className="w-full flex-1 bg-white border-4 border-black rounded-3xl py-4 px-4 md:py-6 md:px-8 flex flex-col md:flex-row items-center gap-4 md:gap-6">
                <div className="flex-1 text-center md:text-left">
                  <h3 className="text-xl md:text-2xl font-bold text-black">Đăng ký nhận bản tin PeerNoted</h3>
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-12">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 rounded-full flex-shrink-0 bg-white flex items-center justify-center">
                  <Image src="/logo.png" alt="PeerNoted Logo" width={20} height={20} className="object-contain w-5 h-5" />
                </div>
                <span className="text-lg md:text-xl font-bold">PeerNoted</span>
              </div>
              <p className="text-gray-400 mb-6 text-sm leading-relaxed">
                Nền tảng học tập thông minh, lưu trữ và kết nối tri thức dành riêng cho sinh viên Việt Nam.
              </p>
              <div className="flex gap-3">
                <a href="#" className="w-10 h-10 bg-[#2F81F7] rounded-full flex items-center justify-center hover:opacity-80 transition-opacity">
                  <Facebook className="w-5 h-5" />
                </a>
                <a href="#" className="w-10 h-10 bg-[#2F81F7] rounded-full flex items-center justify-center hover:opacity-80 transition-opacity">
                  <Twitter className="w-5 h-5" />
                </a>
                <a href="#" className="w-10 h-10 bg-[#FF6B7A] rounded-full flex items-center justify-center hover:opacity-80 transition-opacity">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                ...
                <li><a href="#" className="hover:text-white transition-colors">Diễn đàn</a></li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400 text-sm">
                <li className="flex items-center gap-2">
                  ...
                  <a href="mailto:contact@peernoted.com" className="hover:text-white transition-colors">
                    contact@peernoted.com
                  </a>
                </li>
                <li className="flex items-center gap-2">
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400 text-sm">
            <p>Made by PeerNoted Team - All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
